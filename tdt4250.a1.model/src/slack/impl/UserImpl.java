 ...
 * </p>
 * <ul>
 *   <li>{@link slack.impl.UserImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link slack.impl.UserImpl#getPosts <em>Posts</em>}</li>
 *   <li>{@link slack.impl.UserImpl#getChannels <em>Channels</em>}</li>
 *   <li>{@link slack.impl.UserImpl#getPhoneNumber <em>Phone Number</em>}</li>
 *   <li>{@link slack.impl.UserImpl#getEmail <em>Email</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	public EList<Channel> getChannels() {
		if (channels == null) {
			channels = new EObjectWithInverseResolvingEList.ManyInverse<Channel>(Channel.class, this, SlackPackage.USER__CHANNELS, SlackPackage.CHANNEL__MEMBERS);
		}
		return channels;
	}
	...
	public void setPhoneNumber(String newPhoneNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SlackPackage.USER__PHONE_NUMBER, oldPhoneNumber, phoneNumber));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SlackPackage.USER__EMAIL, oldEmail, email));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SlackPackage.USER__CHANNELS:
				return getChannels();
			case SlackPackage.USER__PHONE_NUMBER:
				return getPhoneNumber();
			case SlackPackage.USER__EMAIL:
				return getEmail();
		}
