 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.a1.slack.impl.PostImpl#getThread <em>Thread</em>}</li>
 *   <li>{@link tdt4250.a1.slack.impl.PostImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link tdt4250.a1.slack.impl.PostImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link tdt4250.a1.slack.impl.PostImpl#getReply <em>Reply</em>}</li>
 *   <li>{@link tdt4250.a1.slack.impl.PostImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PostImpl extends MinimalEObjectImpl.Container implements Post {
	 ...
	 * @generated
	 */
	public tdt4250.a1.slack.Thread getThread() {
		if (eContainerFeatureID() != SlackPackage.POST__THREAD) return null;
		return (tdt4250.a1.slack.Thread)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetThread(tdt4250.a1.slack.Thread newThread, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setThread(tdt4250.a1.slack.Thread newThread) {
		if (newThread != eInternalContainer() || (eContainerFeatureID() != SlackPackage.POST__THREAD && newThread != null)) {
			...
			if (newThread != null)
				msgs = ((InternalEObject)newThread).eInverseAdd(this, SlackPackage.THREAD__POSTS, tdt4250.a1.slack.Thread.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SlackPackage.POST__THREAD:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetThread((tdt4250.a1.slack.Thread)otherEnd, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SlackPackage.POST__THREAD:
				return eInternalContainer().eInverseRemove(this, SlackPackage.THREAD__POSTS, tdt4250.a1.slack.Thread.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SlackPackage.POST__THREAD:
				setThread((tdt4250.a1.slack.Thread)newValue);
				return;
			case SlackPackage.POST__AUTHOR:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case SlackPackage.POST__THREAD:
				setThread((tdt4250.a1.slack.Thread)null);
				return;
			case SlackPackage.POST__AUTHOR:
				setAuthor((User)null);
				return;
