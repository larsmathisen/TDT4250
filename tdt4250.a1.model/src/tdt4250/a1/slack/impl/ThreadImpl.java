 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.a1.slack.impl.ThreadImpl#getPosts <em>Posts</em>}</li>
 *   <li>{@link tdt4250.a1.slack.impl.ThreadImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThreadImpl extends MinimalEObjectImpl.Container implements tdt4250.a1.slack.Thread {
	/**
	...
	public EList<Post> getPosts() {
		if (posts == null) {
			posts = new EObjectContainmentWithInverseEList<Post>(Post.class, this, SlackPackage.THREAD__POSTS, SlackPackage.POST__THREAD);
		}
		return posts;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SlackPackage.THREAD__POSTS:
