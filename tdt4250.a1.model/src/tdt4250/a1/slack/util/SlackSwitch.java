...
public class SlackSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SlackPackage.DIRECT_MESSAGE: {
				DirectMessage directMessage = (DirectMessage)theEObject;
				T result = caseDirectMessage(directMessage);
				if (result == null) result = caseChannel(directMessage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlackPackage.THREAD: {
				tdt4250.a1.slack.Thread thread = (tdt4250.a1.slack.Thread)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Direct Message</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Direct Message</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDirectMessage(DirectMessage object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseThread(tdt4250.a1.slack.Thread object) {
		return null;
	}
